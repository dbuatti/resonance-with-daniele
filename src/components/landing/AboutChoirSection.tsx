  ...
  return (
    <section className="py-16 md:py-24 bg-background text-foreground">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">About Our Choir</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="text-center p-6 shadow-lg rounded-xl">
            <CardHeader className="flex flex-col items-center">
              ...
              <CardTitle className="text-xl font-semibold">What We Believe In</CardTitle>
            </CardHeader>
          ...
          <Card className="text-center p-6 shadow-lg rounded-xl">
            <CardHeader className="flex flex-col items-center">
              ...
              <CardTitle className="text-xl font-semibold">Why Join Us?</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground">
              <ul className="list-none space-y-2">
          ...
          <Card className="text-center p-6 shadow-lg rounded-xl">
            <CardHeader className="flex flex-col items-center">
              ...
              <CardTitle className="text-xl font-semibold">Our Philosophy</CardTitle>
            </CardHeader>
            <CardContent className="text-muted-foreground">
