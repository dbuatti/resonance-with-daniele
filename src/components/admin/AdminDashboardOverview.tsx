...
import { Users, CalendarDays, FileText, PlusCircle, Loader2, Mail, RefreshCw } from "lucide-react"; // Added Mail and RefreshCw icon
...
const AdminDashboardOverview: React.FC = () => {
  ...
  const [interestSubmissionCount, setInterestSubmissionCount] = useState<number | null>(null);
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-end">
        <Button onClick={fetchCounts} disabled={isRefreshing} variant="outline">
          {isRefreshing ? (
